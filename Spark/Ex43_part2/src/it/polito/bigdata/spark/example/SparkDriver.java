...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		SparkConf conf=new SparkConf().setAppName("Spark Ex43 _ part 2");
		...
		JavaPairRDD<String,Count> countRDD = occupancyRDD.mapToPair((line)->{
			...
			minH = (Integer.parseInt(fields[2])/4)*4;
			maxH = minH + 3;
			timeslot = ("["+minH+"-"+maxH+"]");
			id = (timeslot + "_" + fields[0]);
			...
			sensorCount = new Tuple2<String,Count>(id,count);
			return sensorCount;
		});
